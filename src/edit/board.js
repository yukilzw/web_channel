...
import { RulerData, changeBoxByMask } from './utils/rod';
...
const Board = () => {
    ...
    const calcRulerLines = () => {
        ...
        RulerData.rulerPointList = pointsList;
    };
    ...
    const handleMouseUp = (e) => {
        ...
        const nsbcMask = RulerData.nextStylesbYChangeMask;
        ...
        RulerData.nextStylesbYChangeMask = null;
